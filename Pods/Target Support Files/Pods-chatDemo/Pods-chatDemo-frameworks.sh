...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "$BUILT_PRODUCTS_DIR/ImagePiker/ImagePiker.framework"
  ...
  install_framework "$BUILT_PRODUCTS_DIR/LECropPictureViewController/LECropPictureViewController.framework"
